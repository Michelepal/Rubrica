...
public class RestExceptionHandler {
    ...
    ResponseEntity<ApiErrorResponse> generic(Exception exception, HttpServletRequest request) {
        log.error("Errore applicativo non gestito", exception);
        return error(HttpStatus.INTERNAL_SERVER_ERROR, "INTERNAL_ERROR", "Si e' verificato un errore imprevisto.", request, Map.of());
    }
